    ...
    <section id="news" className="max-w-7xl mx-auto px-6 py-16 relative overflow-hidden">
      ...
      >
        {contentData.news.items.map((news, idx) => (
          <Card key={idx} className="group relative bg-white/40 dark:bg-white/5 border-white/20 dark:border-white/10 shadow-xl backdrop-blur-3xl hover:bg-white/60 dark:hover:bg-white/10 transition-all duration-300 rounded-3xl overflow-hidden">
